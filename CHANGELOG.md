...
The complete list of features added:

- A new way to include external content in your books. You can now refer to other books published on github/gitlab. For more info [see the documentation page](https://teachbooks.readthedocs.io/TeachBooks/latest/external.html) and the dedicated [TeachBooks Manual page](https://teachbooks.io/manual/features/external_toc.html) ([#59](https://github.com/TeachBooks/TeachBooks/pull/59)).
...
- a new way to include external content in your books. You can now refer to other books published on github/gitlab. For more info [see the documentation page](https://teachbooks.io/TeachBooks/external.html) ([#59](https://github.com/TeachBooks/TeachBooks/pull/59)).
